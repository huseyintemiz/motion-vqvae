...
def arg_parse(is_train=False):
    ...
    parser.add_argument('--log_every', default=100, type=int, help='iter log frequency')
    parser.add_argument('--save_latest', default=2000, type=int, help='iter save latest model frequency')
