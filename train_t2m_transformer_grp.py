...
from models.mask_transformer.transformer import MaskTransformer,MaskGroupTransformer
from models.mask_transformer.transformer_trainer import MaskTransformerTrainer, MaskGroupTransformerTrainer
...
def load_vq_model():
    ...
    vq_opt.vq_arch_option = 'group_residual_vq' #huseyin
    # vq_opt.vq_arch_option = 'residual_vq' #huseyin

    # vq_opt.quantize_dropout_prob = 0.2
...
if __name__ == '__main__':
    ...
    t2m_transformer_1 = copy.deepcopy(t2m_transformer)
    trainer = MaskTransformerTrainer(opt, t2m_transformer,t2m_transformer_1, vq_model)
    # trainer = MaskGroupTransformerTrainer(opt, t2m_transformer, vq_model)
